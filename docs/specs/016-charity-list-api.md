...
| 版本 | 0.16 |
| 日期 | 2026-06-14 |
| 適用範圍 | `backend/src/routes/user/donation/charities.ts`、`backend/src/routes/user/donation/donation-projects.ts`、`backend/src/routes/user/donation/sale-items.ts`、`backend/src/routes/user/donation/categories.ts`、`backend/src/domain/donation-item/*`、`backend/src/domain/category/*`、`backend/src/schemas/donation-item/*`、`backend/src/schemas/category/*` |
